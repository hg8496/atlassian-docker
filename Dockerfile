...
RUN keytool -import -trustcacerts -keystore /usr/lib/jvm/java-8-oracle/jre/lib/security/cacerts -storepass changeit -alias startcom.ca -file /tmp/cawosign.crt -noprompt
RUN apt-get clean
